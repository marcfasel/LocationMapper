...
![alt Android Location Mapper Locations List](http://pic.twitter.com/hj5xtCoo "Android Location Mapper Locations List")
###Settings
The application can be configured via the settings dialog. 
![alt Android Location Mapper Settings](http://pic.twitter.com/nv3lqQk5 "Android Location Mapper Settings")
